  ...
  return (
    <>
      ...
      <div className="services">
        ...
        <p>While you may have experienced uncomfortable automotive repair shops in the past, with technicians who’ve tried to upsell you parts and service you don’t need, you can rest assured that at Christian Brothers Automotive, we’re different. We are committed to the Nice Difference®, which means we will never recommend unnecessary parts or service, and we will never do anything to your vehicle without your consent. Our team members will walk you through every diagnosis, repair, and part cost with transparent explanations as to why they’re needed. This allows you to be in control to make informed decisions about your automotive repair.</p>

        <h5>Our Repair Estimate Process</h5>
        <p>When you bring your car or truck to us for a diagnosis, our goal is the same as yours: to get you back on the road again as safely and quickly as possible. That’s why our automotive technicians are equipped with a variety of manufacturer diagnostic tools. We don’t want you to have to wait around for the right equipment before getting answers.</p>
